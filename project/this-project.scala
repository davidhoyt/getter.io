...
object ThisProject {
  ...
  object play {
    ...
    def base(path:String)    = root.base(path)
    def version              = root.version
    def settings             = PublishSettings.defaults ++ ReleaseSettings.defaults ++ PlaySettings.defaults ++ BuildSettings.defaults ++ MavenSettings.defaults ++ Defaults.defaultSettings
    def dependencies         = PlaySettings.dependencies
  }
